...
function animate() {
    ...
    cube.rotation.x = -xGradient.value * 8
    cube.rotation.z = -zGradient.value * 4
    cube.rotation.y = -cube.rotation.y

    cube2.rotation.x = -xGradient.value / 4
    cube2.rotation.z = zGradient.value * 4
    cube2.rotation.y = -cube.rotation.y

    cube.material.color.setRGB(redBand.value, greenBand.value, blueBand.value)
    cube2.material.color.setRGB(redBand2.value, greenBand2.value, blueBand2.value)
